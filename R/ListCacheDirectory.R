...
#' @export
#' @keywords internal
#' @details This function is deprecated and has been renamed.  See \code{\link{ListCacheDirectory}}
CacheDirectory  <- function(Source = "", ShowAttributes = FALSE){
  catWarning("This function has been renamed to ListCacheDirectory.", "ListCacheDirectory")
  ListCacheDirectory(Source, ShowAttributes)
}
